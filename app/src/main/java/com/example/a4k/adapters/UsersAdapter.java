package com.example.a4k.adapters;
...
import com.example.a4k.entities.Name;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        new CommonHelper().loadImageAsync(MainApplication.sContext, mValues.get(position).getPicture().getThumbnail(), holder.mImageView, R.mipmap.ic_launcher, R.mipmap.ic_launcher);
